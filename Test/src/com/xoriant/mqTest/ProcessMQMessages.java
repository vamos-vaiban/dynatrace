...
public class ProcessMQMessages {
	// Constants used to read default parameters that are used to connect to the
		// queue manager.
		private static final String PARAM_QUEUE_NAME = "SampleQueue";
		private static final String PARAM_PASSWORD = "passw0rd";
		private static final String PARAM_USERNAME = "app";
		private static final String PARAM_QMGR_CHANNEL_NAME = "DEV.APP.SVRCONN";
		private static final String PARAM_QMGR_NAME = "QM1";
		private static final String PARAM_QMGR_PORT = "1414";
		private static final String PARAM_QMGR_HOST_NAME = "localhost";
		...
		public static JsonObject main(JsonObject args) throws IOException {
			...
			try {
				...
				try {
					...
					while ((receivedMsg = consumer.receive()) != null) {
		 ...
		 * @throws JMSException
		 */
		private static void processMessage(Message receivedMsg) throws JMSException,IOException {
		...
		public static void main(String[] args) {
			...
			try {
				...
				JsonElement element = parser.parse(new FileReader("D:\\MQTest\\MQProdCons\\Test\\configuration.json"));
				...
				System.out.println("fdfd"+retObj);
