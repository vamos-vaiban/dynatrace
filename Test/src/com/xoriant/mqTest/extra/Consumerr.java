package com.xoriant.mqTest.extra;
...
public class Consumerr {
	...
	public static void main(String[] args) throws InterruptedException{
		...
		try {
			...
			consumer2 =context.createConsumer(destination);
			consumer.receiveBody(String.class, 150); // in ms or 15 seconds
			consumer2.receiveBody(String.class, 150);
			}
